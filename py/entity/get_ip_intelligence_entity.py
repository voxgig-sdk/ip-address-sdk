...
class GetIpIntelligenceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetIpIntelligenceEntity(self._client, opts)
    ...
    def data_get(self) -> GetIpIntelligence:
    ...
    def match_get(self) -> GetIpIntelligence:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetIpIntelligence:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetIpIntelligence().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
