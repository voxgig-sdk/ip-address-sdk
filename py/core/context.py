...
class IpAddressContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, IpAddressSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpAddressResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpAddressResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IpAddressError(code, msg, self)
