# IpAddress SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpAddressSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpAddressSDK(...) and IpAddressSDK.test(...) become
#      IpAddressSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipaddress_sdk"
_SDK_CLASS = "IpAddressSDK"
