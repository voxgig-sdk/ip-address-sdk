# IpAddress Golang SDK Reference

Complete API reference for the IpAddress Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *IpAddressSDK`
...
#### `GetIpIntelligence(data map[string]any) IpAddressEntity`
