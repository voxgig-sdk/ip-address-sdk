...
The Golang SDK for the IpAddress API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/ip-address-sdk/go
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/ip-address-sdk/go=../path/to/github.com/voxgig-sdk/ip-address-sdk/go
```
