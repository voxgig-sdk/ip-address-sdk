...
const testSeed = `map[string]any{"entity": map[string]any{"bulk_query_i_p": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_current_ip": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_ip_intelligence": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
