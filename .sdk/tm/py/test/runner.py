...
class IpAddressTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpAddressTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IpAddressTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IpAddressTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
