...
// IpAddress SDK ratelimit feature
...
class IpAddressRatelimitFeature extends IpAddressBaseFeature
{
    ...
    private function _acquire(IpAddressContext $ctx): void
    {
    ...
    private function _track(IpAddressContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
