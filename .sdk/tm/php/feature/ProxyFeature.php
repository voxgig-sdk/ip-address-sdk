...
class IpAddressProxyFeature extends IpAddressBaseFeature
{
    ...
    public function init(IpAddressContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpAddressContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
