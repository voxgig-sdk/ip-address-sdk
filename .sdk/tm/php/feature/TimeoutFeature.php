...
class IpAddressTimeoutFeature extends IpAddressBaseFeature
{
    ...
    private function _with_timeout(IpAddressContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpAddressContext $_ctx, float $ms): void
    {
        $client = $this->client;
