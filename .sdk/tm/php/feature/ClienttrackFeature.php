...
// IpAddress SDK clienttrack feature
...
class IpAddressClienttrackFeature extends IpAddressBaseFeature
{
    ...
    public function PostConstruct(IpAddressContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpAddress-SDK';
