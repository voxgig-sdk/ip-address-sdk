...
class IpAddressRbacFeature extends IpAddressBaseFeature
{
    ...
    private function _required(IpAddressContext $ctx): ?string
    {
    ...
    private function _reject(IpAddressContext $ctx, string $required): void
    {
    ...
    private function _track(IpAddressContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
