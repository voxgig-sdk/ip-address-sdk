...
class IpAddressCacheFeature extends IpAddressBaseFeature
{
    ...
    private function _through(IpAddressContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
