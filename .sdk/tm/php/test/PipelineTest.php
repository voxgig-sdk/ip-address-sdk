...
{
    private static function utility(): IpAddressUtility
    {
        return new IpAddressUtility();
    }
    ...
    private static function ctx(array $over = []): IpAddressContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpAddressContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpAddressOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpAddressError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpAddressOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpAddressMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpAddressOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpAddressMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpAddressOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpAddressMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpAddressSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpAddressMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpAddressResponse([]),
            'result' => new IpAddressResult([]),
        ]);
        [, $err] = IpAddressMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpAddressSpec([]),
            'response' => null,
            'result' => new IpAddressResult([]),
        ]);
        [, $err] = IpAddressMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpAddressSpec(['step' => 's']),
            'response' => new IpAddressResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpAddressResult([]),
        ]);
        [, $err] = IpAddressMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpAddressSpec(['step' => 's']),
            'response' => new IpAddressResponse(self::resp(200, ['v' => 1])),
            'result' => new IpAddressResult([]),
        ]);
        [, $err] = IpAddressMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpAddressSpec(['step' => 's']),
            'response' => new IpAddressResponse(self::resp(200, ['v' => 2])),
            'result' => new IpAddressResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpAddressMakeResponse::call($ctx);
    ...
    {
        $preset = new IpAddressResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpAddressSpec([]),
            'response' => new IpAddressResponse([]),
            'result' => new IpAddressResult([]),
        ...
        [$got, $err] = IpAddressMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpAddressResult([])]);
        [, $err] = IpAddressMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpAddressSpec([]), 'result' => null]);
        [, $err] = IpAddressMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpAddressSpec(['step' => 's']),
            'result' => new IpAddressResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpAddressOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpAddressMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpAddressSpec(['step' => 's']),
            'result' => new IpAddressResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpAddressOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpAddressMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpAddressResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpAddressSpec([]),
            'result' => new IpAddressResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpAddressMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpAddressMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpAddressError('boom', 'boom');
        $utility->fetcher = function (IpAddressContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpAddressSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpAddressMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpAddressContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpAddressMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpAddressResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpAddressContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpAddressSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpAddressMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpAddressResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpAddressSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpAddressMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpAddressMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpAddressMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpAddressResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpAddressDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpAddressResult(['ok' => false])]);
        $this->expectException(IpAddressError::class);
        IpAddressDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpAddressResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpAddressMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpAddressMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpAddressBaseFeature();
        $b = new IpAddressBaseFeature();
        IpAddressFeatureAdd::call($ctx, $a);
        IpAddressFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpAddressBaseFeature
    {
        $f = new IpAddressBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpAddressFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpAddressContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpAddressSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpAddressPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpAddressResponse(['headers' => null]),
            'result' => new IpAddressResult([]),
        ]);
        IpAddressResultHeaders::call($ctx);
