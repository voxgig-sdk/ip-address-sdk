...
local GetIpIntelligenceEntity = {}
GetIpIntelligenceEntity.__index = GetIpIntelligenceEntity


function GetIpIntelligenceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetIpIntelligenceEntity)
  self._name = "get_ip_intelligence"
  self._client = client
...
function GetIpIntelligenceEntity:get_name()
  return self._name
end


function GetIpIntelligenceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetIpIntelligenceEntity.new(self._client, opts)
end


function GetIpIntelligenceEntity:data_set(args)
  if args ~= nil then
...
function GetIpIntelligenceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetIpIntelligenceEntity:match_set(args)
  if args ~= nil then
...
function GetIpIntelligenceEntity:match_get()
...
function GetIpIntelligenceEntity:stream(action, args, callopts)
...
function GetIpIntelligenceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetIpIntelligenceEntity
