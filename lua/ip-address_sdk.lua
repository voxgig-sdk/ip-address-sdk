...
local IpAddressSDK = {}
IpAddressSDK.__index = IpAddressSDK
...
IpAddressSDK._make_feature = _make_feature


function IpAddressSDK.new(options)
  local self = setmetatable({}, IpAddressSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IpAddressSDK:options_map()
...
function IpAddressSDK:get_utility()
  return Utility.copy(self._utility)
end


function IpAddressSDK:get_root_ctx()
  return self._rootctx
end


function IpAddressSDK:prepare(fetchargs)
...
function IpAddressSDK:direct(fetchargs)
  local utility = self._utility
...
function IpAddressSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IpAddressSDK.new(sdkopts)
  sdk.mode = "test"
