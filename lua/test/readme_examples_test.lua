...
local SDK_MODULE = "ip-address_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["bulk_query_i_p"] = { ["test01"] = { id = "test01" } }, ["get_current_ip"] = { ["test01"] = { id = "test01" } }, ["get_ip_intelligence"] = { ["test01"] = { id = "test01" } } } }'
