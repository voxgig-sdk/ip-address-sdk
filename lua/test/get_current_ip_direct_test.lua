...
describe("GetCurrentIpDirect", function()
  it("should direct-load-get_current_ip", function()
    local setup = get_current_ip_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_current_ip", setup.live and "live" or "unit")
...
function get_current_ip_direct_setup(mockres)
