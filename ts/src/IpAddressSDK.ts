...
class IpAddressSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new IpAddressSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return IpAddressSDK.test(testopts, sdkopts)
  }
  ...
  toString() {
    return 'IpAddress ' + this._utility.struct.jsonify(this.toJSON())
  }
