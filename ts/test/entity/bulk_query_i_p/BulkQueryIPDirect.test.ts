...
describe('BulkQueryIPDirect', async () => {
  ...
  test('direct-list-bulk_query_i_p', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-bulk_query_i_p', setup.live)) return
    if (skipIfMissingIds(t, setup, ["bulk_query_i_p01"])) return
