...
describe('GetCurrentIpDirect', async () => {
  ...
  test('direct-load-get_current_ip', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-get_current_ip', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IPADDRESS_TEST_GET_CURRENT_IP_ENTID']
