# IpAddress TypeScript SDK

The TypeScript SDK for the IpAddress API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| Method | Returns | Description |
| --- | --- | --- |
| `IpAddressSDK.test(testopts?, sdkopts?)` | `IpAddressSDK` | Create a test-mode client. |
...
| `client` | `client(): IpAddressSDK` | Return the parent SDK client. |
...
ip-address/
├── src/
│   ├── IpAddressSDK.ts        # Main SDK class
