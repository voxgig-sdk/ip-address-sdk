...
The PHP SDK for the IpAddress API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->BulkQueryIP(null)->list(null, null);
...
```
php/
├── ipaddress_sdk.php          -- Main SDK class
...
The main class (`ipaddress_sdk.php`) exports the SDK class
