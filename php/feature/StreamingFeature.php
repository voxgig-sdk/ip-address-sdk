...
// IpAddress SDK streaming feature
...
class IpAddressStreamingFeature extends IpAddressBaseFeature
{
    ...
    private function _iterate(IpAddressResult $result): \Generator
    {
    ...
    private function _streamable(IpAddressContext $ctx): bool
    {
