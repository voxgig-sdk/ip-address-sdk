...
// IpAddress SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpAddressTestFeature extends IpAddressBaseFeature
{
    ...
    public function init(IpAddressContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpAddressContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IpAddressParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpAddressContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpAddressContext $ctx, $op, $args): array
    {
