...
class IpAddressSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = IpAddressHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = IpAddressHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, IpAddressFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return IpAddressUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = IpAddressHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = IpAddressHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = IpAddressHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    public function direct(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = IpAddressHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function GetCurrentIp($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_current_ip === null) {
                $this->_get_current_ip = new GetCurrentIpEntity($this, null);
            }
            return $this->_get_current_ip;
        }
        return new GetCurrentIpEntity($this, $data);
    }
    ...
    public function GetIpIntelligence($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_ip_intelligence === null) {
                $this->_get_ip_intelligence = new GetIpIntelligenceEntity($this, null);
            }
            return $this->_get_ip_intelligence;
        }
        return new GetIpIntelligenceEntity($this, $data);
    }
