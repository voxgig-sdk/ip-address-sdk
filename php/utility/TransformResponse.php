...
// IpAddress SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpAddressTransformResponse
{
    public static function call(IpAddressContext $ctx): mixed
    {
        ...
        $transform = IpAddressHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
