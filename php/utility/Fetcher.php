...
class IpAddressFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpAddressSDK/1.0)';
    ...
    public static function call(IpAddressContext $ctx, string $fullurl, array $fetchdef): array
    {
