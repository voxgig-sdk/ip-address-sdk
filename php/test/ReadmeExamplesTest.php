...
// IpAddress SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpAddressSDK::test)
...
{
    private const SDK_CLASS = 'IpAddressSDK';
    ...
    private const SDK_BASE = 'ipaddress_sdk';
