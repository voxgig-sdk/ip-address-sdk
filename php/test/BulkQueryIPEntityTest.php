...
class BulkQueryIPEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = IpAddressSDK::test($seed, null);
        $seen = iterator_to_array($base->BulkQueryIP(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->BulkQueryIP(null)->stream("list", null, null) as $item) {
