# IpAddress Ruby SDK Reference

Complete API reference for the IpAddress Ruby SDK.
...
#### `IpAddressSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.BulkQueryIP.list(nil)
```
