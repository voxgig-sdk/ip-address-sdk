...
class BulkQueryIPEntity
  ...
  def make
    opts = @_entopts.dup
    BulkQueryIPEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [BulkQueryIPListMatch, Hash, nil] match filter (any subset of
  #   BulkQueryIP fields); defaults to nil, treated as an empty match that lists all.
