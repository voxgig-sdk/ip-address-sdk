...
class GetCurrentIpEntity
  ...
  def make
    opts = @_entopts.dup
    GetCurrentIpEntity.new(@_client, opts)
  end
  ...
  # @return [GetCurrentIp, Hash] the current GetCurrentIp data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetCurrentIp fields)
  def match_get
  ...
  #
  # @param reqmatch [GetCurrentIpLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetCurrentIp.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetCurrentIp, Hash] the loaded GetCurrentIp; raises IpAddressError on failure
