...
class IpAddressSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = IpAddressHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = IpAddressHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, IpAddressFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    IpAddressUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    params = IpAddressHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = IpAddressHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = IpAddressHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
